...
class StarCraft2Env(MultiAgentEnv):
    ...
    def __init__(
        ...
        self.add_local_obs = cfg.add_local_obs
        self.add_move_state = cfg.add_move_state
        self.add_visible_state = cfg.add_visible_state
        self.add_distance_state = cfg.add_distance_state
        self.add_xy_state = cfg.add_xy_state
        self.add_enemy_action_state = cfg.add_enemy_action_state
        self.add_agent_id = cfg.add_agent_id
        self.use_state_agent = cfg.use_state_agent
        self.use_mustalive = cfg.use_mustalive
        self.add_center_xy = cfg.add_center_xy
        self.use_stacked_frames = cfg.use_stacked_frames
        self.stacked_frames = cfg.stacked_frames
        ...
        self.obs_instead_of_state = cfg.use_obs_instead_of_state
        ...
        self.save_to_replay = save_to_replay
